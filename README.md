...
1. Download or clone this [repostory](https://github.com/sadaf-Daneshgar/math-magicians.git).
...
- Clone this [repository](https://github.com/sadaf-Daneshgar/math-magicians) to your desired folder:

- Example commands:

```sh
  cd [YOUR FOLDER]
  git clone https://github.com/sadaf-Daneshgar/math-magicians.git
```
...
Feel free to check the [issues page](https://github.com/sadaf-Daneshgar/math-magicians/issues).
...
If you like this project, kindly drop a start for the [repository](https://github.com/sadaf-Daneshgar/math-magicians);
